...
max_vector_size = 0
for i, vector in enumerate(bug_Data['word_vector_dfg']):
...
print("BLT MAP DFG:", blt_map)
print("BLT MRR DFG:", blt_mrr)
# print("BLT-FT MAP:", blt_ft_map)
# print("BLT-FT MRR:", blt_ft_mrr)
# print("HybridDL MAP DFG:", hybrid_dl_map)
# print("HybridDL MRR DFG:", hybrid_dl_mrr)
