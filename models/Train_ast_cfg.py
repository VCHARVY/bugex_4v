...
max_vector_size = 0
for i, vector in enumerate(bug_Data['word_vector_ast_cfg']):
...
print("BLT MAP AST CFG:", blt_map)
print("BLT MRR AST CFG:", blt_mrr)
# print("BLT-FT MAP:", blt_ft_map)
# print("BLT-FT MRR:", blt_ft_mrr)
# print("HybridDL MAP AST CFG:", hybrid_dl_map)
# print("HybridDL MRR AST CFG:", hybrid_dl_mrr)
