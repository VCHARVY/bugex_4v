...
csv_file_path = "./creation/Aspectj_word_vectors.csv"
vector_words = []
y_values = []
issues = []
...
max_vector_size = 0
for i, vector in enumerate(bug_Data['word_vector_all']):
    print(f"Processing vector {i+1}/{len(bug_Data['word_vector_all'])}")
...
torch.save(BLT(input_size=X.shape[1], output_size=1).state_dict(), "BLT_all.pth")
# torch.save(BLT_FT(input_size=X.shape[1], output_size=1).state_dict(), "BLT_FT.pth")
# torch.save(HybridDL(input_size=X.shape[1], output_size=1).state_dict(), "HybridDL_all.pth")
...
print("BLT MAP ALL:", blt_map)
print("BLT MRR ALL:", blt_mrr)
# print("BLT-FT MAP:", blt_ft_map)
# print("BLT-FT MRR:", blt_ft_mrr)
# print("HybridDL MAP ALL:", hybrid_dl_map)
# print("HybridDL MRR ALL:", hybrid_dl_mrr)
