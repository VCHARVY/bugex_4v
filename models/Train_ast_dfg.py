...
max_vector_size = 0
for i, vector in enumerate(bug_Data['word_vector_ast_dfg']):
    print(f"Processing vector {i+1}/{len(bug_Data['word_vector_ast_dfg'])}")
...
torch.save(BLT(input_size=X.shape[1], output_size=1).state_dict(), "BLT_ast_dfg.pth")
# torch.save(BLT_FT(input_size=X.shape[1], output_size=1).state_dict(), "BLT_FT.pth")
# torch.save(HybridDL(input_size=X.shape[1], output_size=1).state_dict(), "HybridDL_ast_dfg.pth")
...
print("BLT MAP AST DFG:", blt_map)
print("BLT MRR AST DFG:", blt_mrr)
# print("BLT-FT MAP:", blt_ft_map)
# print("BLT-FT MRR:", blt_ft_mrr)
# print("HybridDL MAP AST DFG:", hybrid_dl_map)
# print("HybridDL MRR AST DFG:", hybrid_dl_mrr)
